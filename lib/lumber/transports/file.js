  ...
  */
  ...
  File = (function(_super) {
    ...
    File.prototype._write = function(data, cb) {
      ...
      if (flushed) {
        ...
        return this._drain(function() {
          console.log("drained to ", data, _this._stream);
          if (_this._needsToRotateLogs()) {
    ...
    File.prototype._needsToRotateLogs = function() {
      var d, shouldIRotate;
      d = new Date();
      shouldIRotate = !(d.getDate() === todaysDate.getDate() && d.getMonth() === todaysDate.getMonth() && d.getYear() === todaysDate.getYear());
    ...
    File.prototype._rotateLogs = function(cb) {
      ...
      return this._close(function() {
        var from, to;
        from = _this.filename;
        to = _this.filename + "." + dateFormat(todaysDate, 'mm-dd-yyyy');
