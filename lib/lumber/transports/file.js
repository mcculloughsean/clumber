...
var File = exports.File = function(options) {
  ...
  self.rotateStyle = lumber.util.checkOption(options.rotateStyle, 'sequentially');
  ...
  self._setRotateStyle(self.rotateStyle);
};
...
File.prototype._setRotateStyle = function(style) {
  console.log("Set style");
  //switch(style)
  //{
  //case 'temporally':
  //this._rotateLogs = File.prototype._rotateLogsTemporally;
  //break;
  //default:
  this._rotateLogs = File.prototype._rotateLogsSequentially;
  //};


};

File.prototype._rotateLogsSequentially = function(cb) {
  console.log("_rotateLogsSequentially");
  var self = this,
  max = 1, exists = false;
  ...
  self._close(function() {
    console.log("_rotateLogsSequentially close cb");
    //loop through each file and move their numbers up
    self._doLogRotateSequentially(max, function(err) {
      console.log("_rotateLogsSequentially close cb _doLogRotateSequentially cb");
...
File.prototype._doLogRotateSequentially = function(num, cb) {
  console.log("_doLogRotateSequentially");
  var self = this;
  ...
  fs.rename(from, to, function(err) {
    ...
    //move the next one
    num--;
    self._doLogRotateSequentially(num, cb);
  });
};
