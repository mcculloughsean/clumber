...
(function() {
  var Process, cp, dateFormat, events, lumber, path, throwError, util,
  ...
  throwError = function(command, args, error) {
  ...
  Process = (function(_super) {
    ...
    function Process(options) {
      ...
      this._childProcess.on('error', function(error) {
        return throwError(_this.command, _this["arguments"], error);
      });
    ...
    Process.prototype._write = function(data, cb) {
      return this._childProcess.stdin.write(data, this.encoding, cb);
    };
