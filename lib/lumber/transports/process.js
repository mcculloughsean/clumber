...
(function() {
  var Process, cp, dateFormat, events, lumber, path, util,
  ...
  Process = (function(_super) {
    ...
    function Process(options) {
      ...
      this.command = lumber.util.checkOption(options.command, ['tee', '/dev/null']);
      ...
      command = this.command.shift();
      this._childProcess = cp.spawn(command, this.command);
    ...
    Process.prototype._write = function(data, cb) {
      this._childProcess.stdin.write(data, this.encoding);
      return cb(null);
    };
